...
class AuthExtUser(AbstractUser):
    ...
    roles = models.JSONField(default=list, null=False, verbose_name='admin-管理员，common-普通用户')
    permissions = models.JSONField(default=list,
                                   null=False, verbose_name='["*:*:*"]-所有 ["permission:btn:add", '
...
class LoginLog(models.Model):
    ...
    def op_log(cls, request, summary):
        ...
        cls.objects.create(ip=ip, address=address, system=system, browser=browser, summary=summary)
...
class Department(models.Model):
    ...
    type = models.CharField(max_length=2, default="1", choices=TYPE_CHOICES, db_index=True, verbose_name='类型')

    description = models.CharField(max_length=2000, null=True, verbose_name='描述')
    remark = models.CharField(max_length=2000, null=True, verbose_name='备注')
