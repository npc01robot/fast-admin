...
class AuthExtUser(AbstractUser, models.Model):
    ...
    avatar = models.CharField(max_length=255, null=True,blank=True,default=None, verbose_name="头像")
    roles = models.ManyToManyField(Role, related_name='users', through='UserRoles', verbose_name="角色")
    permissions = models.JSONField(null=True,blank=True,default=None, verbose_name="权限")
    dept = models.ForeignKey(Department, related_name='users', null=True,blank=True,default=None, on_delete=models.SET_NULL, verbose_name="部门")
    ...
    remark = models.CharField(max_length=2000, null=True,blank=True,default=None, verbose_name="备注")
