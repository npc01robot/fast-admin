...
addIcon("ep:info-filled", InfoFilled);
// @iconify-icons/ri
...
import Shield from "@iconify-icons/ri/shield-fill";
import Finance from "@iconify-icons/ri/funds-fill";
import Money from "@iconify-icons/ri/money-cny-box-fill";
import Cost from "@iconify-icons/ri/paypal-fill";
import Approve from "@iconify-icons/ri/account-box-fill";
...
addIcon("ri:shield-fill", Shield);
addIcon("ri:funds-fill", Finance);
addIcon("ri:money-cny-box-fill", Money);
addIcon("ri:paypal-fill", Cost);
addIcon("ri:account-box-fill", Approve);
addIcon("ri:add-circle-fill", AddCircleFill);
